...
export const BUILT_IN_OPENWORK_EXTENSION_MANIFESTS: OpenWorkExtensionManifest[] = [
  ...
  },
  {
    ...
    id: "univer-cli",
    name: "Univer CLI",
    description: "Offline-ready Univer compatibility set for native .univer spreadsheets, documents, and slides.",
    preview: true,
    source: { format: "openwork-builtin", origin: "builtin", trusted: true },
    icon: { src: "/openwork-mark.svg" },
    composer: { prompt: UNIVER_CLI_COMPOSER_PROMPT },
    setup: {
      instructions: "OpenWork ships one verified compatibility set: published Cowork, its exact Univer SDK cohort, univer-cli, native bindings, and the canonical skill from the locked univer-cli source commit.",
      primaryCta: "Repair Univer distribution",
    ...
    resources: [
      {
        type: "skill",
        id: "univer-cli-skill",
        label: "Canonical univer-cli skill",
        description: "Skill package extracted from the locked dream-num/univer-cli source commit, including references and inspect tools.",
        path: "builtin://univer-cli",
        required: true,
      },
      {
        type: "native-binary",
        id: "univer-distribution-executable",
        label: "Offline univer executable",
