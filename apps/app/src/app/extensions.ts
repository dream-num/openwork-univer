...
export const BUILT_IN_OPENWORK_EXTENSION_MANIFESTS: OpenWorkExtensionManifest[] = [
  ...
  },
  {
    ...
    id: "univer-cli",
    name: "Univer CLI",
    description: "Install Univer CLI and skills so OpenWork can work with native .univer spreadsheets, documents, and slides.",
    preview: true,
    source: { format: "openwork-builtin", origin: "builtin", trusted: true },
    icon: { src: "/openwork-mark.svg" },
    ...
    resources: [
      {
        type: "skill",
        id: "univer-cli-skill",
        label: "univer-cli skill package",
        description: "Complete skill package from dream-num/skills, including references and inspect tools.",
        path: ".opencode/skills/univer-cli",
        required: true,
      },
      {
        type: "native-binary",
        id: "univer-managed-executable",
        label: "OpenWork-managed univer executable",
