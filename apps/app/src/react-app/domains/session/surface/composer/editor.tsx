...
export const LexicalPromptEditor = forwardRef<LexicalPromptEditorHandle, EditorProps>(function LexicalPromptEditor(props, ref) {
  ...
  return (
    <LexicalComposer initialConfig={initialConfig}>
      {/*
        Compact start, bounded growth:
        - min-h keeps the empty composer at a stable two-line prompt height.
      ...
      */}
      <div className="relative" onClickCapture={handlePastedTextExpandPointer} onMouseDownCapture={handlePastedTextExpandMouseDown}>
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className="min-h-[56px] max-h-[180px] w-full resize-none overflow-y-auto bg-transparent text-[15px] leading-6 text-dls-text outline-none placeholder:text-dls-secondary [&_p]:min-h-[1.5rem] [&_p]:m-0"
