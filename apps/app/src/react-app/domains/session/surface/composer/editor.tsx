  ...
  return (
    <LexicalComposer initialConfig={initialConfig}>
      {/*
        ...
        - min-h keeps the empty composer at chat-bar height.
      ...
      */}
      <div className="relative" onClickCapture={handlePastedTextExpandPointer} onMouseDownCapture={handlePastedTextExpandMouseDown}>
        <PlainTextPlugin
          contentEditable={
            <ContentEditable
              className="min-h-[34px] max-h-[180px] w-full resize-none overflow-y-auto bg-transparent text-[15px] leading-6 text-dls-text outline-none placeholder:text-dls-secondary [&_p]:min-h-[1.5rem] [&_p]:m-0"
